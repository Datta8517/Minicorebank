...
//        Long userId = Long.valueOf(claims.get("userId").toString());
        ...
        Account account = accountService.createAccount(userId,req);
        auditLogService.log(
                userId,
                "ACCOUNT CREATED",
...
//            System.out.println("Account is "+req.getStatus());
    ...
    public ResponseEntity<String> approveAccount(@RequestHeader("Authorization") String authHeader, @PathVariable String accountId, HttpServletRequest request) {
