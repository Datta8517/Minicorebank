...
public class AdminController {
    ...
    public ResponseEntity<List<TransactionRecord>> getAllUserTransaction(@PathVariable Long userId) {
        return ResponseEntity.ok(transactionService.getUserTransactions(userId));
    }

    @GetMapping("/all-transactions")
    public ResponseEntity<List<TransactionRecord>> getAllTransaction() {
